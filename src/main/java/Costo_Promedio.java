...
public class Costo_Promedio extends DefaultHandler {
    private static final String CLASS_NAME = Costo_Promedio.class.getName();
    ...
    public static void main(String args[]) {
        ...
        Costo_Promedio handler = new Costo_Promedio();
