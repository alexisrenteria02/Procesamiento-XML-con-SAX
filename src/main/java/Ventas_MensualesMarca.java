...
public class Ventas_MensualesMarca extends DefaultHandler {
    private static final String CLASS_NAME = Ventas_MensualesMarca.class.getName();
    ...
    public static void main(String args[]) {
        ...
        Ventas_MensualesMarca handler = new Ventas_MensualesMarca();
