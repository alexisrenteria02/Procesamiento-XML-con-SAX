...
public class Ventas_Mensuales extends DefaultHandler {
    private static final String CLASS_NAME = Ventas_Mensuales.class.getName();
    ...
    public void endDocument() throws SAXException {
        ...
        for (Map.Entry<String, Double> entry: entries) {
            System.out.printf("Fecha: %-10.10s Total de Ventas $%,9.2f\n",entry.getKey(),entry.getValue());
        }
    ...
    public static void main(String args[]) {
        ...
        Ventas_Mensuales handler = new Ventas_Mensuales();
